...
namespace ESTACIONAMENTO.Controllers
{
    public class CarroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Marca,Modelo,Placa,Id")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Marca,Modelo,Placa,Id")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
